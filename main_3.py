...
class MyConfig():
    def __init__(self):
        self.isis_hash = {}
        self.isis = [0, 0]
        self.octet = [0, 0, 0] # второй и третий октеты
    ...
    def create_interface(self, isis_count):
        ...
        config = [
                ...
                f"            address 100.{self.octet[1]}.{self.octet[2]}.1/24\n",
        ...
        if self.octet[2] == 256:        # если третий октет достиг предельного значения
            self.octet[1] += 1          # увеличим второй октет на единицу
            self.octet[2] = 0           # и обнулим третий
        # elif self.octet[1] == 256:
        #     self.octet[2] += 1
        #     self.octet[1] = 0
